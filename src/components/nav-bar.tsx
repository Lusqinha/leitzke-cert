  ...
  return (
    <nav className="flex items-center justify-between p-6">
      ...
      <div className="hidden md:flex items-center gap-8">
        ...
        <Link href="/servicos" className="text-sm font-medium text-[#2d2d2d] hover:text-[#ffc200]">
          Serviços
        </Link>
        <Link href="/sobre" className="text-sm font-medium text-[#2d2d2d] hover:text-[#ffc200]">
          Sobre
        </Link>
      ...
      <Button variant="outline" className="bg-[#ffc200] text-[#2d2d2d] hover:bg-[#ffc200]/90">
        Agendar horário
      </Button>
    </nav>
  )
